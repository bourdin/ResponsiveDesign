...
# SaveWindowAtts = SaveWindowAttributes()
SaveWindowAtts.fileName = "{}-Struct".format(prefix)
SetSaveWindowAttributes(SaveWindowAtts)
SaveWindow()
...
### Responsive Material
###
ChangeActivePlotsVar("Responsive")

# PseudocolorAtts.colorTableName = "Greens"
...
# SaveWindowAtts = SaveWindowAttributes()
SaveWindowAtts.fileName = "{}-Resp".format(prefix)
SetSaveWindowAttributes(SaveWindowAtts)
SaveWindow()
